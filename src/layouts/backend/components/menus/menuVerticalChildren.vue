...
.layouts-menu-vertical-children .el-menu-item,
.layouts-menu-vertical-children .el-sub-menu__title {
    height: 44px;
    line-height: 44px;
    margin: 2px 10px;
    border-radius: 8px;
...
.layouts-menu-vertical-children .el-menu-item:hover,
.layouts-menu-vertical-children .el-sub-menu__title:hover {
    background-color: #ffffff;
    color: var(--el-menu-active-color);
}
.layouts-menu-vertical-children .el-menu-item.is-active,
.layouts-menu-vertical-children .el-sub-menu.is-active > .el-sub-menu__title {
    background-color: var(--ba-menu-active-bg) !important;
    color: var(--el-menu-active-color) !important;
    font-weight: 600;
}
.layouts-menu-vertical-children .el-menu-item.is-active .menu-title,
.layouts-menu-vertical-children .el-sub-menu.is-active > .el-sub-menu__title .menu-title {
    font-weight: 600;
}
</style>
